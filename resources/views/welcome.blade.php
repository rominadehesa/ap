...
<body>
    ...
    <section id="soluciones" class="">
        <div class="text-center">
            <div class="flex justify-center">
                <span class="text-center text-md mb-10 span-tag">Soluciones inmobiliarias</span>
            </div>
            <h1 class="text-5xl text-[#fff]">Todo lo que necesitás,</h1>
            <h1 class="text-5xl mb-8 text-[#F2BF14] opacity-0 animate-[fadeDown_0.8s_ease-out_forwards]">en un solo
                lugar</h1>
            <div class="flex justify-center">
                <p class="w-[50%] text-white/50 leading-[1.7]">Acompañamos a nuestros clientes con soluciones claras,
                    responsables y
                    personalizadas en cada operación.</p>
            </div>
        </div>
        <div class="flex items-between mt-16">
            <div class="w-full border-r border-white/30 p-8 hover:bg-[#3E153D] hover:border-[#F2BF14] hover:rounded-lg">
                ...
                <div class="mt-8">
                    <div>
                        <p class="text-white font-bold mb-4 text-lg">Venta de propiedades</p>
                        <p class="text-white/50">Diseñamos un plan de marketing con publicidad dirigida, fotografía y
                            video
                            para lograr mayor visibilidad y encontrar al comprador adecuado.</p>
                    </div>
                    <div class="mt-2">
                        <a href="#" class="text-white text-sm bg-transparent border-white border-b">
                            Consultar →
                        </a>
                    </div>
                </div>
            ...
            <div class="w-full p-8 border-r border-white/30 hover:bg-[#3E153D] hover:border-[#F2BF14] hover:rounded-lg">
                ...
                <div class="mt-8">
                    <div>
                        <p class="text-white font-bold mb-4 text-lg">Tasaciones</p>
                        <p class="text-white/50">Realizamos tasaciones con análisis del mercado y un informe detallado
                            para
                            determinar el valor adecuado de cada propiedad.</p>
                    </div>
                    <div class="mt-2">
                        <a href="#" class="text-white text-sm bg-transparent border-white border-b">
                            Consultar →
            ...
            <div class="w-full p-8 hover:border-r hover:bg-[#3E153D] hover:border-[#F2BF14] hover:rounded-lg">
                <svg width="41" height="41" viewBox="0 0 41 41" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <rect width="41" height="41" rx="8" fill="#F2BF14" fill-opacity="0.101961" />
                    <path
                ...
                <div class="mt-8">
                    <div>
                        ...
                        <p class="text-white font-bold mb-4 text-lg">Asesoramiento legal</p>
                        <p class="text-white/50">Revisión de contratos y documentación para proteger tus intereses en
                            cada
                            transacción.</p>
                    </div>
                    <div class="mt-2">
    ...
    <section id="explorar">
        ...
        <div class="flex justify-between gap-20">
            <div class="w-[40%]">
                <h1 class="text-5xl text-start mb-8">Encontrá la propiedad que estas buscando</h1>
            ...
            <div class="w-[50%] overflow-hidden">
                <div class="flex items-center justify-between pb-1">
                    ...
                    <div class="flex gap-6">
                        <button class="text-lg font-dm text-[#3E153D] border-b-2 border-[#3E153D]">
                            Destacadas
                        </button>
                    </div>
                </div>
    ...
    <section id="quiénessomos">
        ...
        <div class="flex justify-between mb-20">
            <div class="w-[30vw]">
                <h1 class="text-start text-5xl">Comprometidas con</h1>
                <h1 class="text-start text-5xl mb-8 text-[#471C46]">cada operación</h1>
                <div>
                    <p class="leading-[1.7] w-[80%]">Nos enfocamos en ofrecer un asesoramiento claro, responsable y
            ...
            <div class="w-[30vw]">
                <div>
                    <article
                        ...
                        id="valores">
                        <div class="w-[50%]">
                            <h3 class="text-6xl font-bold">+<span class="counter" data-target="10">0></span></h3>
                        </div>
                        <div>
                    ...
                    <article
                        ...
                        id="valores">
                        <div class="w-[50%]">
                            <h3 class="text-6xl font-bold">+<span class="counter" data-target="80">0></span></h3>
                        </div>
                        <div>
                    ...
                    <article
                        ...
                        id="valores">
                        <div class="w-[50%]">
                            <h3 class="text-6xl font-bold"><span class="counter" data-target="100">0></span>%</h3>
                        </div>
                        <div>
        ...
        <div class="flex justify-between items-end">
            <button class="text-2xl font-dm font-extrabold text-[#3E153D]">
                Conoce a nuestro equipo
            </button>
            <div>
                <a href="#" class="text-[#3E153D] border-b border-[#3E153D] text-md font-extrabold transition">
                    Saber más →
                </a>
            </div>
        </div>
        <div class="flex justify-between gap-2 mb-20 mt-8">
            <div class="border border-purple-100 rounded-2xl p-8">
                <!-- Header -->
                <div class="flex items-center gap-4 mb-5">
                    <div
                        class="h-14 w-14 rounded-xl bg-purple-100 flex items-center justify-center text-center shrink-0">
                        <span class="text-[#3E153D] font-extrabold text-lg text-center">YA</span>
                    </div>
                    <div>
                        <p class="text-lg font-extrabold text-gray-800 leading-tight">Yanina Alaguibe</p>
                        <p class="text-xs font-medium text-[#3E153D]">Martillera y Corredora Inmobiliaria</p>
                    </div>
                </div>

                <!-- Separador -->
                <hr class="border-purple-50 mb-2" />

                <!-- Tag -->
                <span
                    class="mb-4 inline-flex items-center gap-2 bg-yellow-50 rounded-full px-4 py-1.5 text-xs font-semibold text-yellow-700">
                ...
                <p class="text-sm text-gray-400 leading-relaxed">
                    Más de 15 años en el sector inmobiliario con experiencia en cierres de ventas
                    y asesoramiento integral. Guía cada operación con criterio y conocimiento del mercado.
                </p>

                <!-- Stat -->
                <!--div class="flex items-baseline gap-2 mt-5 pt-4 border-t border-purple-50">
                    <span class="text-3xl font-extrabold text-yellow-400">+15</span>
                    <span class="text-sm text-gray-300">años de experiencia</span>
                </div-->
            </div>
            <div class="border border-purple-100 rounded-2xl p-8">
                <!-- Header -->
